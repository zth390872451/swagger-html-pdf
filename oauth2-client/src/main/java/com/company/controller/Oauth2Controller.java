...
@Api(description = "获取OAuth2的AccessToken",tags = {"获取AccessToken"})
public class Oauth2Controller {
	 ...
	 * OAuth2的密码授权模式
	 */
	@ApiOperation(value = "密码授权模式", notes = "密码授权模式")
	@ApiImplicitParams({
			@ApiImplicitParam(name = "client_id", value = "客户端的ClientId", paramType = "path", dataType = "string", required = true),
			@ApiImplicitParam(name = "client_secret", value = "客户端的ClientSecret", paramType = "path", dataType = "string", required = true),
			@ApiImplicitParam(name = "grant_type", value = "授权类型", paramType = "path", dataType = "string", required = true),
			@ApiImplicitParam(name = "username", value = "用户名", paramType = "path", dataType = "string", required = true),
			@ApiImplicitParam(name = "password", value = "密码", paramType = "path", dataType = "string", required = true)
	})
	 ...
	 * Oauth2的受信任的客户端授权模式
	 */
	@ApiOperation(value = "受信任的客户端模式", notes = "受信任的客户端模式")
	@ApiImplicitParams({
			@ApiImplicitParam(name = "client_id", value = "客户端的ClientId", paramType = "path", dataType = "string", required = true),
			@ApiImplicitParam(name = "client_secret", value = "客户端的ClientSecret", paramType = "path", dataType = "string", required = true),
			@ApiImplicitParam(name = "grant_type", value = "授权类型", paramType = "path", dataType = "string", required = true)
